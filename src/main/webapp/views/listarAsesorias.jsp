    ...
    <body>
        ...
        <div class="container mt-5" style="min-height: 750px;">
          ...
          <div class="row">
            <div class="col-lg-4 col-sm-12">
              <form method="GET" action="/crearAsesoriasSv" id="formCrearAsesoria">
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-body">
                Confirma la eliminación de la asesoria.
              </div>
              <div class="modal-footer">
                <form method="post" action="EliminarAsesoriaSv" id="formEliminarAsesoria">
        ...
        <div class="modal fade " id="modalEditar" tabindex="-1" aria-labelledby="etiquetaModal2" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="etiquetaModal2">Editar asesoria</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <div class="container" style="height: 750px;">
                  <div class="row d-flex justify-content-center justify-content-center">
                    <div class="col-lg-6 col-sm-12 rounded shadow p-3">
                      <form method="post" action="EditarAsesoriaSv" id="formEditarAsesoria">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="inputNombre" name="nombre_asesoria">
                        </div>
                        <div class="mb-3">
                          <label for="inputIdTipoRiesgo" class="form-label">Id tipo riesgo</label>
                          <input type="number" class="form-control" id="inputIdTipoRiesgo" name="id_tipo_riesgo">
                        </div>
                        <div class="mb-3">
                          <label for="inputDescripcion" class="form-label">Descripción de la asesoria</label>
                          <input type="text" class="form-control" id="inputDescripcion" name="descripcion_asesoria">
                        </div>
                        <div class="mb-3">
                          <label for="inputFecha" class="form-label">Fecha de ingreso</label>
                          <input type="date" class="form-control" id="inputFecha" name="fecha_ingreso">
                        </div>
                        <div class="mb-3">
                          <label for="inputIdClientePeticion" class="form-label" hidden>Id cliente peticion</label>
                          <input type="number" class="form-control" id="inputIdClientePeticion" name="id_cliente_peticion" hidden>
                        </div>
                        <div class="mb-3">
                          <label for="inputEstado" class="form-label" hidden>Estado</label>
                          <input type="number" class="form-control" id="inputEstado" name="estado" hidden>
                        </div>
        ...
        <script>
          var table = $('#tablaAsesorias').DataTable()
          $(document).ready(function() {
            ...
            $('#btnModalEditar').click(function () {
              ...
              if (seleccionadas) {
                ...
                $('#inputIdTipoRiesgo').val(data[2])
                $('#inputDescripcion').val(data[3])
                $('#inputFecha').val(data[4])
                $('#inputIdClientePeticion').val(data[5])
                $('#inputEstado').val(data[6])
              }
            })
